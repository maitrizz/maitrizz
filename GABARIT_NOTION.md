...
> ⚠️ **Statut : LABORATOIRE.** Tant que ce gabarit n'est pas marqué « figé », **on ne construit que la notion 1**. On n'industrialise les autres notions qu'une fois les conventions stabilisées (changer d'avis coûte presque rien tant qu'une seule notion existe).
