          ...
          blocks: [
            ...
            },
            {
              ...
              questions: [
                ...
                {
                  objectifId: "e9",
                  question: "Comment expliquer à des élèves de cycle 3 que la somme des angles d'un triangle vaut 180° ?",
                  options: ["En admettant que c'est une règle", "En déchirant les trois coins et en les alignant : ils forment un angle plat", "Avec le théorème de Thalès", "En calculant (3 − 2) × 180°"],
                  correctIndex: 1,
                  explanation: "Au cycle 3, on procède par manipulation : déchirer les trois angles et les aligner forme un angle plat (180°), avant toute démonstration formelle.",
                },
              ],
            },
            {
