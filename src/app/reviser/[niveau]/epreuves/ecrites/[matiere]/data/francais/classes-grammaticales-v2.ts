// PROTOTYPE — Notion 01 « Classes grammaticales » repensée selon la nouvelle
// architecture (3 maisons : Apprendre court / S'entraîner à la carte / Mémo).
// Vit sur une URL séparée pour comparer avec la fiche d'origine, sans risque.
// Slug : classes-grammaticales-v2.
...
// Savoir-faire de la notion = filtre « Ce que je travaille » (Exercices + trainer).
// Multi-tag côté items/exercices. Voir GABARIT_NOTION.md §4.
const SAVOIR_FAIRE = [
...
export const ficheClassesGrammaticalesV2: Fiche = {
  slug: "classes-grammaticales-v2",
  matiere: "francais",
  numero: 1,
  partie: "Partie 1 : Grammaire de la phrase",
  title: "Classes grammaticales · PROTOTYPE (nouvelle architecture)",
  subtitle: "Version d'essai : Apprendre court, puis s'entraîner à la carte. À comparer avec la fiche d'origine.",
  badges: [{ label: "Prototype", variant: "info" }],
  metaTitle: "Classes grammaticales · prototype | Maitrizz",
  metaDescription: "Prototype de la notion classes grammaticales selon la nouvelle architecture pédagogique.",
  tabGroups: [
    {
      id: "apprendre",
      label: "Apprendre",
          ...
          blocks: [
            ...
            },
            {
              ...
              correction: [
                ...
                { type: "note", text: "Méthode en tête ? Direction S'entraîner pour l'automatiser." },
              ],
            },
            {
              type: "ctaBox",
