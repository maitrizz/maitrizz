          ...
          blocks: [
            {
              ...
              items: [
                ...
                },
                {
                  number: "④",
                  title: "Tout ordonner",
                  text: "Les permutations et la factorielle n!, et le lien vers les probabilités ([N°12](fiche:probabilites)).",
                },
              ],
            },
          ],
          ...
          blocks: [
            ...
            },
            {
              ...
              questions: [
                ...
                {
                  objectifId: "e4",
                  question: "Pour dénombrer les issues de deux séries de choix indépendants (3 formes, 3 couleurs), quel outil et combien d'issues ?",
                  options: [
                    "Un arbre, 6 issues",
                    "Un tableau à double entrée, 3 × 3 = 9 issues",
                    "Une addition, 3 + 3 = 6 issues",
                    "Une factorielle, 3! = 6 issues",
                  ],
                  correctIndex: 1,
                  explanation: "Un tableau à double entrée (formes en colonnes, couleurs en lignes) associe une case à chaque issue : 3 × 3 = 9 combinaisons. Le principe multiplicatif se lit dans la grille.",
                },
                {
                  objectifId: "e2",
                ...
                {
                  objectifId: "e8",
                  question: "Un élève de CM2 écrit « 3 formes et 3 couleurs → 3 + 3 = 6 cartes ». Quelle aide concrète proposer ?",
                  options: [
                    "Lui donner directement la formule 3 × 3",
                    "Lui faire remplir un tableau à double entrée pour visualiser les 9 combinaisons",
                    "Lui dire simplement que c'est faux",
                    "Reporter l'activité au collège",
                  ],
                  correctIndex: 1,
                  explanation: "L'élève applique le principe additif à des caractéristiques cumulatives. Faire remplir un tableau à double entrée rend visibles les 3 × 3 = 9 cartes : la manipulation précède la formule.",
                },
              ],
            },
            {
