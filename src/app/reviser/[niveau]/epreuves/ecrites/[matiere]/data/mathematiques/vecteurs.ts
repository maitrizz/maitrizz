          ...
          blocks: [
            ...
            },
            {
              ...
              questions: [
                ...
                {
                  objectifId: "e2",
                  question: "Le vecteur AB⃗ est le vecteur de quelle transformation ?",
                  options: ["La rotation de centre A", "La translation qui transforme A en B", "La symétrie d'axe (AB)", "L'homothétie de rapport 2"],
                  correctIndex: 1,
                  explanation: "AB⃗ est le vecteur de la translation qui transforme A en B ; deux vecteurs égaux décrivent la même translation.",
                },
                {
                  objectifId: "e3",
                ...
                {
                  objectifId: "e5",
                  question: "AB⃗ et AD⃗ partent du même point A. Que vaut leur somme AB⃗ + AD⃗ ?",
                  options: ["BD⃗", "AC⃗, où ABCD est un parallélogramme", "0⃗", "AA⃗"],
                  correctIndex: 1,
                  explanation: "Règle du parallélogramme : si AB⃗ et AD⃗ partent de A, leur somme est AC⃗, la diagonale du parallélogramme ABCD.",
                },
                {
                  objectifId: "e6",
                ...
                {
                  objectifId: "e9",
                  question: "Pour démontrer avec des vecteurs que A, B, C sont alignés, que cherche-t-on ?",
                  options: [
                    "Que AB⃗ = AC⃗",
                    "Un réel k tel que AC⃗ = k·AB⃗ (colinéarité)",
                    "Que ‖AB⃗‖ = ‖AC⃗‖",
                    "Que ABC est un triangle",
                  ],
                  correctIndex: 1,
                  explanation: "A, B, C sont alignés si AB⃗ et AC⃗ sont colinéaires, c'est-à-dire s'il existe un réel k tel que AC⃗ = k·AB⃗.",
                },
              ],
            },
            {
