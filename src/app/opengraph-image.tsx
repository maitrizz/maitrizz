...
// Vignette de partage (Open Graph / Twitter) de la page d'accueil, dans la même
// charte que celles des fiches et des matières : fond crème, quadrillage Seyès,
// titres en Source Serif, accent terracotta.
export const alt = "Maitrizz · Préparez le concours CRPE";
      ...
      >
        ...
        <div style={{ position: "relative", display: "flex", gap: 28 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            >
              Préparez le CRPE sans vous perdre.
            </div>
            <div
              style={{
                fontFamily: "Source Serif",
            ...
            >
              Fiches de cours, méthode, exercices corrigés et sujets blancs, construits à partir
              des programmes officiels et des rapports de jury.
            </div>
          </div>
        </div>
        ...
        >
          <span>Fiches, exercices et sujets blancs</span>
